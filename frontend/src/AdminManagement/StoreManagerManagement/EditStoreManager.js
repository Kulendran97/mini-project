...
export default class EditStoreManager extends Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:4000/storeManager/'+this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.put('http://localhost:4000/storeManager/update/'+this.props.match.params.id, Manager)
